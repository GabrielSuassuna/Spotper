...
module.exports = {
    ...
    async showTrack(req,res){
        ...
        const result = await sql.query`select f.descricao, f.tempo, f.num_faixa, f.cod_album from Faixa as f, Playlist as p, Faixa_Playlist as fp
        where f.num_faixa=fp.num_faixa and f.cod_album=fp.cod_album and fp.cod_playlist=${req.params.id}
        GROUP BY f.descricao, f.tempo, f.num_faixa, f.cod_album`
        res.send(result.recordset)
    },
